        ...
        <div className='ml-16' >
        {
            data.length === 0 ? <>
            ...
            </> : <>
                {
                    ...
                    <thead>
                        <tr>
                            <th className="border-2 border-blue-500 px-2 py-1">Employee Name</th>
                            <th className="border-2 border-blue-500 px-2 py-1">Employee Code</th>
                            <th className="border-2 border-blue-500 px-2 py-1">Gate Pass Valid Till</th>
                        </tr>
                    </thead>
                    <tbody>
                        {data.map((item, index) => (
                            <tr key={index} className='hover:bg-slate-300 cursor-pointer'>
