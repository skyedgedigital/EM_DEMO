    ...
    <div className='p-5'>
      ...
      >
        ...
        <ol className="list-decimal ml-5 my-3">
          ...
          <li>
            <span>Deduction if Any Advance : {(wagesData?.existingWage?.advanceDeduction)} </span>{"   "}
            <span className="ml-6">Deduction if Any Damage : {(wagesData?.existingWage?.damageDeduction)} </span>{" "}
