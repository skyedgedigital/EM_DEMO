...
export const BillingItemColumns: ColumnDef<IBillingWorkOrderItem>[] = [
  {
...

  {
    ...
    cell: ({ row }) => {
      ...
      const handleDeleteItem = async (itemNumber: number) => {
        ...
        try {
          const res =
            await billingItemActions.DELETE.deleteBillingItemByItemNumber(
              itemNumber
            );
      ...
      return (
        <DropdownMenu>
          ...
          <DropdownMenuContent>
            <DropdownMenuItem onClick={() => handleDeleteItem(item.itemNumber)}>
              Delete
            </DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
